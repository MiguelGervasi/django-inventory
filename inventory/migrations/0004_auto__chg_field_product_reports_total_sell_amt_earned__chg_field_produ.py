...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventory_product_reports', 'total_sell_amt_earned', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2))

        # Changing field 'Product_Reports.total_unit_amt_earned'
        db.alter_column(u'inventory_product_reports', 'total_unit_amt_earned', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2))

        # Changing field 'Product_Reports.total_quantity_sold'
        db.alter_column(u'inventory_product_reports', 'total_quantity_sold', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Product_Reports.total_profit_earned'
        db.alter_column(u'inventory_product_reports', 'total_profit_earned', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product_Reports.total_quantity_sold'
        db.alter_column(u'inventory_product_reports', 'total_quantity_sold', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'inventory.product_reports': {
            ...
            'total_profit_earned': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'total_quantity_sold': ('django.db.models.fields.IntegerField', [], {}),
            'total_sell_amt_earned': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'total_unit_amt_earned': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'})
        }
    }
