...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inventory_product_reports', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('total_sell_amt_earned', self.gf('inventory.fields.CurrencyField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('total_unit_amt_earned', self.gf('inventory.fields.CurrencyField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('total_profit_earned', self.gf('inventory.fields.CurrencyField')(null=True, max_digits=10, decimal_places=2, blank=True)),
        ))
    ...
    models = {
        ...
        u'inventory.product_reports': {
            ...
            'report_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
